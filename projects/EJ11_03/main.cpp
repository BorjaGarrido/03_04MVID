...
void render(const Geometry& floor, const Geometry& object, const Shader& s_phong, const Shader& s_stencil, const Shader& s_blend,
    ...
    s_stencil.set("color", 1.0f, 0.0f, 0.0f, 0.8f);
    ...
    s_stencil.set("color", 0.0f, 1.0f, 0.0f, 0.6f);
    model = glm::mat4(1.0f);
    ...
    s_stencil.set("color", 0.0f, 0.0f, 1.0f, 0.4f);
    model = glm::mat4(1.0f);
...
int main(int, char* []) {
    ...
    while (window->alive()) {
        ...
        render(quad, cube, s_phong, s_stencil, s_blend, t_albedo, t_specular, t_tree);
        window->frame();
    }
